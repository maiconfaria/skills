...
description: Use when transforming monolithic Terraform configurations into reusable, maintainable modules following HashiCorp's module design principles and community best practices.
metadata:
  author: IBM
  source: https://github.com/hashicorp/agent-skills
  source-path: terraform/module-generation/skills/refactor-module

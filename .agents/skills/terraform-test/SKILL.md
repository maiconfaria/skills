---
name: terraform-test
description: Use when writing and running Terraform tests (.tftest.hcl files). Use when creating test scenarios with run blocks, validating infrastructure behavior with assertions, mocking providers and data sources, testing module outputs and resource configurations, or troubleshooting Terraform test syntax and execution.
metadata:
  author: IBM
  source: https://github.com/hashicorp/agent-skills
  source-path: terraform/code-generation/skills/terraform-test

...
description: Use when running acceptance tests for a Terraform provider. Use when asked to run a test with the prefix `TestAcc`.
license: MPL-2.0
metadata:
  author: IBM
  source: https://github.com/hashicorp/agent-skills
  source-path: terraform/provider-development/skills/run-acceptance-tests

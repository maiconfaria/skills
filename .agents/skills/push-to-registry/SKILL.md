...
description: Use when pushing Packer build metadata to HCP Packer registry for tracking and managing image lifecycle. Use when integrating Packer builds with HCP Packer for version control and governance.
metadata:
  author: hashicorp
  source: https://github.com/hashicorp/agent-skills
  source-path: packer/hcp/skills/push-to-registry
---

...
description: Use when building Amazon Machine Images (AMIs) with Packer using the amazon-ebs builder. Use when creating custom AMIs for EC2 instances.
metadata:
  author: hashicorp
  source: https://github.com/hashicorp/agent-skills
  source-path: packer/builders/skills/aws-ami-builder
---

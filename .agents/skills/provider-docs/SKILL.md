---
name: provider-docs
description: Use when creating, updating, or reviewing Terraform provider documentation for Terraform Registry using HashiCorp-recommended patterns, tfplugindocs templates, and schema descriptions. Use when adding or changing provider configuration, resources, data sources, ephemeral resources, list resources, functions, or guides. Use when validating generated docs or troubleshooting missing or incorrect Registry documentation.
metadata:
  author: hashicorp
  source: https://github.com/hashicorp/agent-skills
  source-path: terraform/provider-development/skills/provider-docs
---

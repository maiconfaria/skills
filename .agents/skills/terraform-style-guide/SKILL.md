...
description: Use when generating, writing, or reviewing Terraform HCL code following HashiCorp's official style conventions and best practices.
metadata:
  author: hashicorp
  source: https://github.com/hashicorp/agent-skills
  source-path: terraform/code-generation/skills/terraform-style-guide
---
